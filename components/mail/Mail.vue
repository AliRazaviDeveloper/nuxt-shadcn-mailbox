...
import type { LinkProp } from "../partials/The-Header.vue";
import { refDebounced } from "@vueuse/core";
import { cn } from "~/lib/utils";
import AccountSwitcher from "./AccountSwitcher.vue";
import TheHeader from "../partials/The-Header.vue";
  ...
  <TooltipProvider :delay-duration="0">
    ...
    >
      ...
      >
        ...
        <Separator />
        <The-Header :is-collapsed="isCollapsed" :links="links" />
        <Separator />
        <The-Header :is-collapsed="isCollapsed" :links="links2" />
      </ResizablePanel>
